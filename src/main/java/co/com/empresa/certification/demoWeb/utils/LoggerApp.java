package co.com.empresa.certification.demoWeb.utils;
...
/**
 * Clase principal para el manejo de la bitácora o log del aplicativo
 * Ejemplo adaptado de 'https://medium.com/el-acordeon-del-programador/logs-en-java-con-java-util-logging-d344ae2ba7bc'
 */
public class LoggerApp {
     ...
     */
    private static final Logger LOG = Logger.getLogger("co.com.empresa.certification.demoWeb");
